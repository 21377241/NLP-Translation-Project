...
python src/train_rnn.py \
    ...
    --checkpoint_dir experiments/rnn_en2zh/checkpoints \
    --log_dir experiments/rnn_en2zh/logs

echo ""
echo "✓ RNN 英译中模型训练完成！"
echo "检查点位置: experiments/rnn_en2zh/checkpoints/"
